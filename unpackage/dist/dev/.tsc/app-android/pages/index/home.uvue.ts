...
const _component_cl_page = resolveEasyComponent("cl-page",_easycom_cl_page)
  ...
  return _cV(_component_cl_page, null, _uM({
    default: withSlotCtx((): any[] => [
      ...
      _cE("view", _uM({ class: "mainContainer" }), [
        _cV(unref(MsgNotifier), _uM({ class: "msg-notifier" })),
        _cE("view", _uM({ class: "p-3 ml-2 mr-2 mt-2" }), [
          _cV(_component_cl_text, _uM({
            color: "primary",
            pt: {
            ...
            default: withSlotCtx((): any[] => [_tD(unref(t)('设备运行统计'))]),
            _: 1 /* STABLE */
          })),
          _cV(unref(EchartEquipCard))
        ])
      ]),
...
const GenPagesIndexHomeStyles = [_uM([["mainContainer", _pS(_uM([["position", "relative"], ["width", "100%"]]))], ["msg-notifier", _pS(_uM([["position", "absolute"], ["top", "70rpx"]]))]])]
