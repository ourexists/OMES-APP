  ...
  return _cV(_component_cl_page, null, _uM({
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "p-3" }), [
        _cE("view", _uM({ class: "flex flex-col items-center justify-center py-10" }), [
          _cE("view", _uM({ class: "p-3" }), [
          ...
          _cV(_component_cl_text, _uM({ pt: { className: 'mt-3 mb-1' } }), _uM({
          ...
          _cV(_component_cl_text, _uM({
            ...
            default: withSlotCtx((): any[] => ["version " + _tD(unref(config).version)]),
            _: 1 /* STABLE */
          }))
        ])
      ])
