...
const _component_cl_page = resolveEasyComponent("cl-page",_easycom_cl_page)
  ...
  return _cV(_component_cl_page, null, _uM({
    default: withSlotCtx((): any[] => [
      _cE("view", _uM({ class: "p-10 flex flex-col items-center justify-center" }), [
        _cV(_component_cl_text, _uM({ pt: { className: 'text-center mb-5' } }), _uM({
          default: withSlotCtx((): any[] => ["专注工业控制解决方案"]),
          _: 1 /* STABLE */
        })),
        _cE("view", _uM({ class: "p-2 bg-white mb-5 rounded-xl" }), [
