...
import { ctx, hasTextColor, hasTextSize, parsePt, useCache } from "../../cool";
import type { ClTextType } from "../../types";
import { useSize } from "../../hooks";
import { isDark } from "../../theme";

type PassThrough = { __$originalPosition?: UTSSourceMapPosition<"PassThrough", "uni_modules/cool-unix/components/cl-text/cl-text.uvue", 149, 6>;
	className?: string;
};
...
const textStyle = computed(() => {
	const style = {__$originalPosition: new UTSSourceMapPosition("style", "uni_modules/cool-unix/components/cl-text/cl-text.uvue", 194, 8),};
...
return (): any | null => {
  ...
  return _cE("text", _uM({
    class: _nC(["cl-text", [_uM<string, any | null>({}),
			_uM({
				'cl-text--pre-wrap': _ctx.preWrap,
				'cl-text--ellipsis': _ctx.ellipsis,
    ...
    renderSlot(_ctx.$slots, "default", {}, (): any[] => [_tD(content.value)])
  ], 14 /* CLASS, STYLE, PROPS */, ["selectable", "space", "decode"])
}
}

})
export default __sfc__
export type ClTextComponentPublicInstance = InstanceType<typeof __sfc__>;
const GenUniModulesCoolUnixComponentsClTextClTextStyles = [_uM([["cl-text--ellipsis", _pS(_uM([["textOverflow", "ellipsis"]]))], ["cl-text--default-size", _pS(_uM([["fontSize", "28rpx"], ["lineHeight", "42rpx"]]))]])]
