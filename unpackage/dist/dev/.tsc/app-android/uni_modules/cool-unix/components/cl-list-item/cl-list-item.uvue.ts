...
type PassThrough = { __$originalPosition?: UTSSourceMapPosition<"PassThrough", "uni_modules/cool-unix/components/cl-list-item/cl-list-item.uvue", 197, 6>;
...
// 计算透传样式
type Swipe = { __$originalPosition?: UTSSourceMapPosition<"Swipe", "uni_modules/cool-unix/components/cl-list-item/cl-list-item.uvue", 212, 6>;
	width: number; // 滑动区域宽度
	maxX: number; // 最大滑动距离
...
const _component_cl_collapse = resolveEasyComponent("cl-collapse",_easycom_cl_collapse)
  ...
  return _cE("view", _uM({
    ...
    _cV(_component_cl_collapse, _uM({
      ...
      "onUpdate:modelValue": $event => {(isCollapse).value = $event},
      pt: {
