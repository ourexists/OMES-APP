...
/**
 * 根据对象属性对数组进行分组
 * @example groupBy([{types: 'a'}, {types: 'b'}, {types: 'a'}], 'types') // {a: [{types: 'a'}, {types: 'a'}], b: [{types: 'b'}]}
 */
...
/**
 * 遍历数组
 * @example forEach([1, 2, 3], x => __f__('log','at uni_modules/cool-unix/cool/utils/comm.ts:429',x))
 */
...
/**
 * 遍历对象
 * @example forInObject({a: 1, b: 2}, (value, key) => __f__('log','at uni_modules/cool-unix/cool/utils/comm.ts:460',key, value))
 */
 ...
 * @example debounce(() => __f__('log','at uni_modules/cool-unix/cool/utils/comm.ts:515','执行'), 300)
 */
 ...
 * @example
 * const throttled = throttle(() => __f__('log','at uni_modules/cool-unix/cool/utils/comm.ts:540','执行'), 300)
 * throttled()
 */
