...
class Storage {
	 ...
	 * if (userData != null) {
	 *   __f__('log','at uni_modules/cool-unix/cool/utils/storage.ts:20',userData);
	 * }
	 */
	 ...
	 * __f__('log','at uni_modules/cool-unix/cool/utils/storage.ts:37','所有存储数据：', allData);
	 */
	info() {
		// 获取存储信息，包含所有键名
	 ...
	 *   __f__('log','at uni_modules/cool-unix/cool/utils/storage.ts:88','token已过期');
	 * }
	 */
