...
import {debounce, get, isEmpty, isFunction, isNull, last, map, nth, storage, toArray} from "../utils";
        ...
        if (this.isFirstPage()) {
            ...
            if (this.eventsMap.beforeEach != null) {
                ...
                if (to != null) {
                    ...
                    __f__('error','at uni_modules/cool-unix/cool/router/index.ts:244',"[router] found to page is null");
                }
            } else {
                next();
            }
