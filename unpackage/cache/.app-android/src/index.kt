...
fun initRuntimeSocketService(): UTSPromise<Boolean> {
    val hosts: String = "192.168.1.18,127.0.0.1,172.19.80.1"
    val port: String = "8090"
    val id: String = "app-android_0M6CRW"
    if (hosts == "" || port == "" || id == "") {
...
inline fun <reified T> parseObject(data: String): T? {
    return UTSAndroid.consoleDebugError(JSON.parseObject<T>(data), " at uni_modules/cool-unix/cool/utils/parse.uts:20")
}
...
fun <T> parseToObject(data: T): UTSJSONObject {
    return UTSAndroid.consoleDebugError(JSON.parseObject(JSON.stringify(data ?: UTSJSONObject())!!), " at uni_modules/cool-unix/cool/utils/parse.uts:95")!!
}
...
open class Config (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Config", "uni_modules/cool-unix/config.uts", 2, 6)
    }
...
open class DayUts : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("DayUts", "uni_modules/cool-unix/cool/utils/day.uts", 6, 14)
    }
...
open class Storage : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Storage", "uni_modules/cool-unix/cool/utils/storage.uts", 9, 7)
    }
    ...
    open fun info(): UTSJSONObject {
        ...
        val d: UTSJSONObject = object : UTSJSONObject(UTSSourceMapPosition("d", "uni_modules/cool-unix/cool/utils/storage.uts", 41, 15)) {
        }
...
open class BackOptions (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("BackOptions", "uni_modules/cool-unix/cool/types/index.uts", 4, 13)
    }
}
open class PushOptions (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PushOptions", "uni_modules/cool-unix/cool/types/index.uts", 12, 13)
    }
}
open class PageInstance (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PageInstance", "uni_modules/cool-unix/cool/types/index.uts", 25, 13)
    }
}
open class RouteInfo (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("RouteInfo", "uni_modules/cool-unix/cool/router/index.uts", 5, 6)
    }
}
open class Page (
    @JsonNotNull
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Page", "uni_modules/cool-unix/cool/ctx/index.uts", 2, 6)
    }
}
...
open class Events (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Events", "uni_modules/cool-unix/cool/router/index.uts", 16, 6)
    }
}
open class SubPackage (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("SubPackage", "uni_modules/cool-unix/cool/ctx/index.uts", 7, 6)
    }
}
open class TabBarItem (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("TabBarItem", "uni_modules/cool-unix/cool/ctx/index.uts", 11, 13)
    }
}
open class TabBar (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("TabBar", "uni_modules/cool-unix/cool/ctx/index.uts", 18, 13)
    }
}
open class Ctx (
    @JsonNotNull
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Ctx", "uni_modules/cool-unix/cool/ctx/index.uts", 35, 13)
    }
}
val ctx = parse<Ctx>(object : UTSJSONObject() {
    ...
    var globalStyle = object : UTSJSONObject() {
        var navigationBarTitleText = "OMES"
...
open class Router : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Router", "uni_modules/cool-unix/cool/router/index.uts", 21, 14)
    }
    ...
    open fun defaultPath(name: String): String {
        val paths: UTSJSONObject = object : UTSJSONObject(UTSSourceMapPosition("paths", "uni_modules/cool-unix/cool/router/index.uts", 33, 15)) {
        ...
        if (this.isFirstPage()) {
            ...
            if (this.eventsMap.beforeEach != null) {
                ...
                if (to != null) {
                    ...
                    console.error("[router] found to page is null", " at uni_modules/cool-unix/cool/router/index.ts:244")
                }
            } else {
                next()
            }
...
open class Refs : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Refs", "uni_modules/cool-unix/cool/hooks/refs.uts", 8, 7)
    }
...
open class Scroller : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Scroller", "uni_modules/cool-unix/cool/scroller/index.uts", 2, 7)
    }
...
open class AnimationAttribute (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("AnimationAttribute", "uni_modules/cool-unix/cool/animation/index.uts", 11, 13)
    }
}
open class AnimationOptions (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("AnimationOptions", "uni_modules/cool-unix/cool/animation/index.uts", 28, 13)
    }
}
...
open class AnimationEngine : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("AnimationEngine", "uni_modules/cool-unix/cool/animation/index.uts", 264, 14)
    }
    ...
    private fun runAndroidAnimation(): Unit {
        ...
        open class frameCallback : Choreographer.FrameCallback, IUTSSourceMap {
            override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
                return UTSSourceMapPosition("frameCallback", "uni_modules/cool-unix/cool/animation/index.uts", 804, 15)
            }
...
open class CacheData (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("CacheData", "uni_modules/cool-unix/cool/hooks/cache.uts", 3, 6)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class UseCache (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("UseCache", "uni_modules/cool-unix/cool/hooks/cache.uts", 6, 6)
    }
}
...
val iconfont: UTSJSONObject = object : UTSJSONObject(UTSSourceMapPosition("iconfont", "uni_modules/cool-unix/icons/iconfont/index.uts", 1, 14)) {
    var back = "e6db"
    var yue = "e6bb"
    var wancheng = "e6bc"
    var shibai = "e6bd"
...
val remixicon: UTSJSONObject = object : UTSJSONObject(UTSSourceMapPosition("remixicon", "uni_modules/cool-unix/icons/remixicon/index.uts", 1, 14)) {
...
val icons: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("icons", "uni_modules/cool-unix/icons/index.uts", 3, 14), "iconfont" to iconfont, "remixicon" to remixicon)
...
open class PassThroughProps (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThroughProps", "uni_modules/cool-unix/types/index.uts", 3, 13)
    }
}
...
open class ClSelectOption (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClSelectOption", "uni_modules/cool-unix/types/index.uts", 21, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class ClConfirmBeforeCloseEvent (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClConfirmBeforeCloseEvent", "uni_modules/cool-unix/types/index.uts", 27, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class ClConfirmOptions (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClConfirmOptions", "uni_modules/cool-unix/types/index.uts", 32, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class ClToastOptions (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClToastOptions", "uni_modules/cool-unix/types/index.uts", 61, 13)
    }
}
open class ClListItem (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClListItem", "uni_modules/cool-unix/types/index.uts", 76, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class ClListViewItem (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClListViewItem", "uni_modules/cool-unix/types/index.uts", 84, 13)
    }
}
...
open class ClSelectDateShortcut (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClSelectDateShortcut", "uni_modules/cool-unix/types/index.uts", 112, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class ClFormRule (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClFormRule", "uni_modules/cool-unix/types/index.uts", 117, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class ClFormValidateError (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClFormValidateError", "uni_modules/cool-unix/types/index.uts", 131, 13)
    }
}
...
open class ClTreeItem (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClTreeItem", "uni_modules/cool-unix/types/index.uts", 147, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class ClTreeNodeInfo (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClTreeNodeInfo", "uni_modules/cool-unix/types/index.uts", 157, 13)
    }
}
open class ClIconPassThrough (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClIconPassThrough", "uni_modules/cool-unix/components/cl-icon/props.uts", 1, 13)
    }
}
open class ClIconProps (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClIconProps", "uni_modules/cool-unix/components/cl-icon/props.uts", 4, 13)
    }
}
open class ClLoadingPassThrough (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClLoadingPassThrough", "uni_modules/cool-unix/components/cl-loading/props.uts", 2, 13)
    }
}
open class ClLoadingProps (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClLoadingProps", "uni_modules/cool-unix/components/cl-loading/props.uts", 6, 13)
    }
}
open class ClFooterOffset : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClFooterOffset", "uni_modules/cool-unix/components/cl-footer/offset.uts", 3, 14)
    }
...
open class Size__1 : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Size", "uni_modules/cool-unix/hooks/size.uts", 8, 7)
    }
    open var names = _uA(
        "text-xs",
        "text-sm",
...
open class Touch : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Touch", "uni_modules/cool-unix/hooks/touch.uts", 1, 14)
    }
...
open class UiInstance (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("UiInstance", "uni_modules/cool-unix/hooks/ui.uts", 9, 13)
    }
}
val list = Map<String, UiInstance>()
open class Ui : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Ui", "uni_modules/cool-unix/hooks/ui.uts", 36, 7)
    }
...
open class Form : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Form", "uni_modules/cool-unix/hooks/form.uts", 4, 14)
    }
...
open class PassThrough (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-form/cl-form.uvue", 82, 6)
    }
}
open class Page__1 : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Page", "uni_modules/cool-unix/hooks/page.uts", 2, 7)
    }
...
open class PassThrough__1 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-icon/cl-icon.uvue", 53, 6)
    }
}
open class Icon (
    @JsonNotNull
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Icon", "uni_modules/cool-unix/components/cl-icon/cl-icon.uvue", 67, 6)
    }
}
...
open class PassThrough__2 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-text/cl-text.uvue", 149, 6)
    }
}
...
open class PassThrough__3 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-button/cl-button.uvue", 325, 6)
    }
}
open class PassThrough__4 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-loading/cl-loading.uvue", 64, 6)
    }
}
...
open class HeaderPassThrough (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("HeaderPassThrough", "uni_modules/cool-unix/components/cl-popup/cl-popup.uvue", 217, 6)
    }
}
open class PassThrough__5 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-popup/cl-popup.uvue", 222, 6)
    }
}
open class Swipe (
    @JsonNotNull
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Swipe", "uni_modules/cool-unix/components/cl-popup/cl-popup.uvue", 370, 6)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class ToastItem (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ToastItem", "uni_modules/cool-unix/components/cl-toast/cl-toast.uvue", 65, 6)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class PassThrough__6 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-form-item/cl-form-item.uvue", 122, 6)
    }
}
open class FormItem : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("FormItem", "uni_modules/cool-unix/hooks/form.uts", 88, 7)
    }
...
val proxy: UTSJSONObject = object : UTSJSONObject(UTSSourceMapPosition("proxy", "config/proxy.uts", 1, 14)) {
    var dev = object : UTSJSONObject() {
        var target = "https://222qc09hk796.vicp.fun"
...
val isDev = "development" == "development"
...
open class WxConfig (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("WxConfig", "config/index.uts", 8, 6)
    }
}
open class Config__1 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Config", "config/index.uts", 12, 6)
    }
}
...
val apiPath: UTSJSONObject = object : UTSJSONObject(UTSSourceMapPosition("apiPath", "core/apiRouter/path.uts", 1, 14)) {
    ...
    var workshop_realtime = "/workshop/getWorkshopRealtimeCollect" as String
}
val authParam: UTSJSONObject = object : UTSJSONObject(UTSSourceMapPosition("authParam", "core/apiRouter/path.uts", 26, 14)) {
    var client_id = "mes" as String
    var client_sc = "admin123" as String
}
inline fun <reified T> parseData(data: Any): T? {
    return UTSAndroid.consoleDebugError(JSON.parseObject<T>(JSON.stringify(data)), " at core/utils/parse.uts:5")
}
open class UserInfo (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("UserInfo", "core/types/index.uts", 1, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class Message (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Message", "core/types/index.uts", 23, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class UTSError (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Error", "core/types/index.uts", 36, 13)
    }
}
open class EquipConfigAttr (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("EquipConfigAttr", "core/types/index.uts", 47, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class EquipConfigDetail (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("EquipConfigDetail", "core/types/index.uts", 53, 13)
    }
}
open class EquipConfig (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("EquipConfig", "core/types/index.uts", 58, 13)
    }
}
open class EquipCollect (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("EquipCollect", "core/types/index.uts", 62, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class Equip (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Equip", "core/types/index.uts", 68, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class EquipAttr (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("EquipAttr", "core/types/index.uts", 83, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
class EquipAttrReactiveObject : EquipAttr, IUTSReactive<EquipAttr> {
    ...
    override var __v_isShallow: Boolean
    override var __v_skip: Boolean
    constructor(__v_raw: EquipAttr, __v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean) : super(name = __v_raw.name, value = __v_raw.value, unit = __v_raw.unit, equipId = __v_raw.equipId) {
        this.__v_raw = __v_raw
        this.__v_isReadonly = __v_isReadonly
        this.__v_isShallow = __v_isShallow
        this.__v_skip = __v_skip
...
open class EquipCount (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("EquipCount", "core/types/index.uts", 89, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class WorkshopTreeNode (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("WorkshopTreeNode", "core/types/index.uts", 97, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class WorkshopScada (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("WorkshopScada", "core/types/index.uts", 105, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class WorkshopRealtimeCollect (
    @JsonNotNull
    open var name: String,
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("WorkshopRealtimeCollect", "core/types/index.uts", 109, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
        return WorkshopRealtimeCollectReactiveObject(this, __v_isReadonly, __v_isShallow, __v_skip)
    }
}
class WorkshopRealtimeCollectReactiveObject : WorkshopRealtimeCollect, IUTSReactive<WorkshopRealtimeCollect> {
    override var __v_raw: WorkshopRealtimeCollect
    override var __v_isReadonly: Boolean
    override var __v_isShallow: Boolean
    override var __v_skip: Boolean
    constructor(__v_raw: WorkshopRealtimeCollect, __v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean) : super(name = __v_raw.name, map = __v_raw.map, value = __v_raw.value, unit = __v_raw.unit) {
        this.__v_raw = __v_raw
        this.__v_isReadonly = __v_isReadonly
        this.__v_isShallow = __v_isShallow
        this.__v_skip = __v_skip
    }
    override fun __v_clone(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): WorkshopRealtimeCollectReactiveObject {
        return WorkshopRealtimeCollectReactiveObject(this.__v_raw, __v_isReadonly, __v_isShallow, __v_skip)
    }
    override var name: String
        get() {
            return _tRG(__v_raw, "name", __v_raw.name, __v_isReadonly, __v_isShallow)
...
val messages: UTSJSONObject = object : UTSJSONObject(UTSSourceMapPosition("messages", "locale/index.uts", 18, 7)) {
...
open class Store (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Store", "core/store/index.uts", 3, 6)
    }
}
open class DictItem (
    @JsonNotNull
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("DictItem", "core/store/dict.uts", 6, 13)
    }
}
open class RequestOptions__1 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("RequestOptions", "core/service/index.uts", 6, 13)
    }
}
open class Token (
    @JsonNotNull
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Token", "core/store/user.uts", 8, 13)
    }
}
...
open class DictData (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("DictData", "core/store/dict.uts", 16, 13)
    }
}
open class Dict : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Dict", "core/store/dict.uts", 21, 14)
    }
...
open class Response (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Response", "core/service/index.uts", 18, 13)
    }
}
open class LoginTokenResponse (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("LoginTokenResponse", "core/service/index.uts", 23, 13)
    }
}
...
fun disconnectMessage() {
    console.log("sse client disconnect=======", " at components/msg-notifier.ts:113")
    isStop = true
    isConnected = false
    isConnecting = false
}
open class User : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("User", "core/store/user.uts", 14, 14)
    }
...
fun connectMessage(): UTSPromise<Unit> {
    return wrapUTSPromise(suspend w@{
            console.log("sse connect start", " at components/msg-notifier.ts:44")
            if (isConnected || isConnecting) {
                console.log("sse connect is connecting", " at components/msg-notifier.ts:46")
                return@w
            }
            isStop = false
            isConnecting = true
            fun poll() {
                ...
                try {
                    ...
                    request(RequestOptions__1(url = apiPath["message_page"] as String, method = "POST", data = object : UTSJSONObject() {
                        ...
                        console.error(err, " at components/msg-notifier.ts:78")
                    }
                    )
                    request(RequestOptions__1(url = apiPath["message_unread_count"] as String, method = "GET")).then(fun(res){
                        ...
                        console.error(err, " at components/msg-notifier.ts:91")
                    }
                    )
                }
                 catch (err: Throwable) {
                    console.warn("poll error", err, " at components/msg-notifier.ts:94")
                }
                 finally {
                    setTimeout(fun(){
                        poll()
...
fun onNotify() {
    if (notifyQueue.value.length <= 0) {
        ...
        if (isDev) {
            console.log(JSON.stringify(msg) + "-" + notify_visible.value + "-" + notify_enable.value, " at components/msg-notifier.ts:144")
        }
...
open class GenApp : BaseApp {
    constructor(__ins: ComponentInternalInstance) : super(__ins) {
        onLaunch(fun(_: OnLaunchOptions) {
            ...
            val user = useStore().user
            if (user.isUnLogin()) {
                console.log("未登陆", " at App.uvue:20")
                user.logout()
                return
            }
            connectMessage()
        ...
        onAppShow(fun(_: OnShowOptions) {
            console.log("App Show", " at App.uvue:27")
            if (router.isLoginPage(router.path())) {
                return
            }
            val user = useStore().user
            if (user.isUnLogin()) {
                console.log("未登陆", " at App.uvue:33")
                user.logout()
                return
            }
            user.get()
...
open class PassThrough__7 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-image/cl-image.uvue", 161, 6)
    }
}
...
open class PassThrough__8 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-topbar/cl-topbar.uvue", 118, 6)
    }
}
...
open class PassThrough__9 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-select-trigger/cl-select-trigger.uvue", 122, 6)
    }
}
...
open class PassThrough__10 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-empty/cl-empty.uvue", 77, 6)
    }
}
...
open class ClSelectTriggerPassThrough (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClSelectTriggerPassThrough", "uni_modules/cool-unix/components/cl-select-trigger/props.uts", 3, 13)
    }
}
open class ClPopupHeaderPassThrough (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClPopupHeaderPassThrough", "uni_modules/cool-unix/components/cl-popup/props.uts", 2, 13)
    }
}
open class ClPopupPassThrough (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClPopupPassThrough", "uni_modules/cool-unix/components/cl-popup/props.uts", 6, 13)
    }
}
open class PassThrough__11 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-select/cl-select.uvue", 156, 6)
    }
}
...
open class PassThrough__12 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-footer/cl-footer.uvue", 52, 6)
    }
}
...
open class Item (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Item", "components/tabbar.uvue", 57, 6)
    }
}
...
open class PassThrough__13 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-noticebar/cl-noticebar.uvue", 97, 6)
    }
}
open class Scroll (
    @JsonNotNull
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Scroll", "uni_modules/cool-unix/components/cl-noticebar/cl-noticebar.uvue", 106, 6)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class Echarts : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Echarts", "uni_modules/lime-echart/components/l-echart/uvue.uts", 5, 14)
    }
    ...
    open fun init() {
        ...
        this.context.addEventListener("message", fun(e: UniWebViewMessageEvent){
            ...
            if (key == "log" && data != null) {
                console.log(data, " at uni_modules/lime-echart/components/l-echart/uvue.uts:29")
            }
    ...
    open fun on(type: String, query: Any, callback: EchartsEventHandler) {
        ...
        console.warn("uvue 暂不支持事件", " at uni_modules/lime-echart/components/l-echart/uvue.uts:94")
    }
    open fun on(type: String, callback: EchartsEventHandler) {
        ...
        console.warn("uvue 暂不支持事件", " at uni_modules/lime-echart/components/l-echart/uvue.uts:102")
    }
...
open class WorkshopTree : IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("WorkshopTree", "components/workshop/workshopTree.uts", 14, 14)
    }
...
open class Badge (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Badge", "core/utils/equipParser.uts", 3, 13)
    }
}
...
typealias StatusFilterKey = String?
...
open class MessageSetPayload (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("MessageSetPayload", "pages/index/components/message-set.uvue", 29, 13)
    }
}
...
open class PassThrough__14 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-avatar/cl-avatar.uvue", 62, 6)
    }
}
...
open class PassThrough__15 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-collapse/cl-collapse.uvue", 35, 6)
    }
}
...
open class ClImagePassThrough (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClImagePassThrough", "uni_modules/cool-unix/components/cl-image/props.uts", 3, 13)
    }
}
open class ClImageProps (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClImageProps", "uni_modules/cool-unix/components/cl-image/props.uts", 9, 13)
    }
}
open class PassThrough__16 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-list-item/cl-list-item.uvue", 197, 6)
    }
}
open class Swipe__1 (
    @JsonNotNull
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Swipe", "uni_modules/cool-unix/components/cl-list-item/cl-list-item.uvue", 212, 6)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class ClListItemPassThrough (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClListItemPassThrough", "uni_modules/cool-unix/components/cl-list-item/props.uts", 4, 13)
    }
}
open class PassThrough__17 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-list/cl-list.uvue", 79, 6)
    }
}
...
open class PassThrough__18 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-switch/cl-switch.uvue", 100, 6)
    }
}
open class Rect (
    @JsonNotNull
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Rect", "uni_modules/cool-unix/components/cl-switch/cl-switch.uvue", 124, 6)
    }
}
...
open class LoginForm (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("LoginForm", "pages/user/types/index.uts", 1, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class PassThrough__19 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-input/cl-input.uvue", 227, 6)
    }
}
...
open class PassThrough__20 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-tree/cl-tree.uvue", 71, 6)
    }
}
open class PassThrough__21 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-tree-item/cl-tree-item.uvue", 115, 6)
    }
}
...
open class ClTextPassThrough (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ClTextPassThrough", "uni_modules/cool-unix/components/cl-text/props.uts", 2, 13)
    }
}
open class PassThrough__22 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-tag/cl-tag.uvue", 89, 6)
    }
}
...
open class PassThrough__23 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PassThrough", "uni_modules/cool-unix/components/cl-select-date/cl-select-date.uvue", 264, 6)
    }
}
...
fun defineAppConfig() {
    ...
    __uniConfig.globalStyle = _uM("navigationBarTitleText" to "OMES", "navigationBarTextStyle" to "@navTextStyle", "backgroundColorContent" to "@bgContentColor", "backgroundColor" to "@bgColor", "navigationBarBackgroundColor" to "@navBgColor")
